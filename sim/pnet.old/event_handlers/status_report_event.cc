...
StatusReportEvent::StatusReportEvent(EventList& eventlist, simtime_picosec period, StopLogger *stop_logger, size_t flow_count) : EventSource(eventlist, "StatusReport") {
    this->period = period;
