...
class Packet {
 ...
 public:
    ...
    inline void set_high_priority(bool b = true) {this->_high_priority = b;}
    inline bool is_high_priority() const {return _high_priority;}
...
class PacketDB {
 ...
 private:
    vector<P*> _alloclist; // The list of every packet ever allocated.
};
