...
class MultipathTcpLoggerSampling : public Logger, public EventSource {
public:
    MultipathTcpLoggerSampling(simtime_picosec period, EventList& eventlist,
                               MultipathTcpLogger::MultipathTcpEvent event_type);
    virtual void doNextEvent();
    void monitorMultipathTcpSource(MultipathTcpSrc* src);

private:
    void logMultipathTcpEvent(MultipathTcpSrc& mtcp, MultipathTcpLogger::MultipathTcpEvent ev);

    MultipathTcpLogger::MultipathTcpEvent _event_type;
    vector<MultipathTcpSrc *> _srcs;
    simtime_picosec _period;
};
